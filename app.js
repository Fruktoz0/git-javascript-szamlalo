...
btns.forEach((btn)=>{
    ...
    //Az összes gomb közül, amelyeket bejárok a ciklussal, azt kattintom meg amelyik az aktuális ciklusfutáskor jön a sorba (első ciklusfutás -> 0.indexü gomb (decrease) stb...)
...
increase.addEventListener("click", ()=>{
    ...
    //Majd az alapértékem aktuális értéket beállítom a value id-val ellátott spamnek
    value.textContent = count;
})
...
decrease.addEventListener("click", ()=>{
    ...
    if(count < 0){
        ...
        //Ha kisebb, hozzáadok egy zöld betűszínt
        value.style.color = "red";
    }
